...
/* jeżeli czy_wewnatrz == 1, to przedział ma postać [minimum, maximum]  */
/* jeżeli czy_wewnątrz == 0, to przediał ma postać                      */
/* [-INFINITY, minimum] + [maximum, +INFINITY]                          */
/* jeżeli czy_pusty == 1, to minimum, maximum i czy_wewnatrz są równe 0 */
